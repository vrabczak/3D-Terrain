...
exports.geoKeys = exports.geoKeyNames = exports.LercAddCompression = exports.LercParameters = exports.ExtraSamplesValues = exports.photometricInterpretations = exports.registerTag = exports.fieldTypes = exports.fieldTypeNames = exports.arrayFields = exports.fieldTagTypes = exports.fieldTags = exports.fieldTagNames = void 0;
...
function registerTag(tag, name, type = undefined, isArray = false) {
    exports.fieldTags[name] = tag;
    exports.fieldTagNames[tag] = name;
    if (type) {
        exports.fieldTypes[name] = type;
    }
    if (isArray) {
        exports.arrayFields.push(tag);
    }
}
